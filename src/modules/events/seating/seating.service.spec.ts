...
import type { SeatMapRow, SeatRow } from './seating.types';
...
describe('SeatingService', () => {
  let repo: jest.Mocked<SeatingRepository>;
  ...
  beforeEach(() => {
    ...
    } as unknown as jest.Mocked<SeatingRepository>;
    events = {
    ...
    service = new SeatingService(repo, events, tickets);
  });
