...
import { EVENTS_ATTENDEES_EMAIL_REQUESTED } from '../events/attendees-email-requested.event';
...
describe('AttendeeBroadcastService', () => {
  ...
  beforeEach(() => {
    repo = {
      findEvent: jest.fn().mockResolvedValue({ id: 'e1' }),
    ...
    service = new AttendeeBroadcastService(repo, stats, outbox, clock);
  });
