...
export class UpdatedTicketResponseDto extends TicketResponseDto {
  @ApiProperty({
    example: 2,
    description:
      'Waitlisted registrations given a place by this change, in line order (US-REG-04): paid ones held for the offer window and sent the offer, free ones confirmed. 0 when the allocation did not rise, the event has no open general-admission waitlist, nobody is waiting, or the person at the front wants more than is free.',
  })
